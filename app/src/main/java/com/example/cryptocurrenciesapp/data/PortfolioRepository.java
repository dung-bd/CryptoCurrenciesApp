...
public class PortfolioRepository {
    ...
    private void getCurrencyById(String id, ApiService currencyService, ApiService valueService) {
    ...
    private void getCurrencyValue(Currency currency, ApiService valueService) {
